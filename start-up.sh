...
cd ..
sed -i "0,/POSTGRES_HOST=.*/s//POSTGRES_HOST='${postgres_ip}'/" bash_scripts/provision.sh
sed -i "0,/CASSANDRA_CONTACT_POINTS=.*/s//CASSANDRA_CONTACT_POINTS='${cassandra_ip}:9042'/" bash_scripts/provision.sh
